...
public class ClimbSubsystem extends SubsystemBase {
  private CANSparkMax rightClimbMotor = new CANSparkMax(1, MotorType.kBrushless); //TODO: replace IDs with constant variables
  private CANSparkMax leftClimbMotor = new CANSparkMax(2, MotorType.kBrushless);
