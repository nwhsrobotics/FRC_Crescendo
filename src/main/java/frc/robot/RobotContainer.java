...
public class RobotContainer {
    ...
    private void configureButtonBindings() {
        new JoystickButton(driver, 3).onTrue(new InstantCommand(() -> swerveSubsystem.gyro.zeroYaw()));
        new JoystickButton(driver, 2).onTrue(new InstantCommand(() -> swerveSubsystem.switchFR()));
        new JoystickButton(driver, 4).onTrue(new InstantCommand(() -> swerveSubsystem.gyro.zeroYaw()));
